...
ms.locfileid: "52338850"
---
# <a name="whats-new-in-the-azure-toolkit-for-eclipse"></a><span data-ttu-id="a6caa-103">Novidades no Kit de Ferramentas do Azure para Eclipse</span><span class="sxs-lookup"><span data-stu-id="a6caa-103">What's new in the Azure Toolkit for Eclipse</span></span>

<span data-ttu-id="a6caa-104">A página da Web a seguir contém informações sobre as várias versões e atualizações mais recentes do Kit de Ferramentas do Azure para Eclipse.</span><span class="sxs-lookup"><span data-stu-id="a6caa-104">The following web page contains information on the various releases and latest updates to the Azure Toolkit for Eclipse.</span></span>

<https://github.com/Microsoft/azure-tools-for-java/releases>

> [!NOTE] 
> <span data-ttu-id="a6caa-105">Há também um kit de ferramentas do Azure para o IDE do IntelliJ.</span><span class="sxs-lookup"><span data-stu-id="a6caa-105">There is also an Azure Toolkit for the IntelliJ IDE.</span></span> <span data-ttu-id="a6caa-106">Para obter mais informações, confira [Kit de Ferramentas do Azure para IntelliJ].</span><span class="sxs-lookup"><span data-stu-id="a6caa-106">For more information, see [Azure Toolkit for IntelliJ].</span></span> 
> 
...
## <a name="next-steps"></a><span data-ttu-id="a6caa-107">Próximas etapas</span><span class="sxs-lookup"><span data-stu-id="a6caa-107">Next steps</span></span>
