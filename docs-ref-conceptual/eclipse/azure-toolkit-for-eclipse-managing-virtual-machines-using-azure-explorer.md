...
1. Na janela **Selecionar uma Imagem de Máquina Virtual**, insira as seguintes informações:
...
1. Na janela **Criar Nova Conta de Armazenamento**, insira as seguintes informações:
